...
def weather_data_scraper(year, months):
    '''
    year - int or string of year to scrape data
    months - list or iter of ints between 1 and 12 for months you want to scrape
    '''
    ...
    for month in months_str:
        final_calendar[month] = calendar[month]

    for month in final_calendar:
        for day in final_calendar[month]:
